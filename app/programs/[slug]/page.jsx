// import { programs } from "@/data/programs"; // ⬅️ NOT from "@/app/page"
...
//             <h1 className="text-3xl md:text-5xl font-semibold text-white">{program.title}</h1>
//           </div>
//         </div>
//       </section>
...
// export async function getsStaticPaths() {
//   return {
